...
LABEL maintainer="aryan170101013@iitg.ac.in"
LABEL version="0.1"
LABEL description="pytorch + raterio + some other libraries"
#
...
RUN pip3 --no-cache-dir install rasterio fiona segmentation-models-pytorch
